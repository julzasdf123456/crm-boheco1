...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4>Disconnection Collection</h4>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="col-lg-12">
            <div class="card shadow-none">
                <div class="card-header">
                    <span class="card-title">Collection Calendar</span>
                </div>
                <div class="card-body">
...
@push('page_scripts')
    <script>
        ...
        function fetchCalendarData(month) {
            ...
            // QUERY SCHEDS
            $.ajax({
                url : '{{ route("disconnectionSchedules.get-schedules-collection-calendar-data") }}',
                type : 'GET',
                data : {
                    Month : month
                },
                success : function(res) {
                    ...
                    $.each(res, function(index, element) {
                        var obj = {}
                        var timestamp = moment(res[index]['DisconnectionDate'], 'YYYY-MM-DD')
                        ...
                        obj['extendedProps'] = {
                           Name : res[index]['DisconnectorName'],
                           Date : res[index]['DisconnectionDate'],
                        }
                    ...
                    calendar = new Calendar(calendarEl, {
                        ...
                        eventClick : function(info) {
                            window.location.href = "{{ url('/disconnection_datas/disco-teller-module-view') }}/" + info.event.extendedProps['Name'] + "/" + info.event.extendedProps['Date']
                        }
                    });
