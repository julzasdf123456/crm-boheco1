    ...
    <div class="col-lg-8 offset-lg-2 col-md-12">
        ...
        <div class="card shadow-none">
            <div class="card-header bg-info">
                <span class="card-title"><strong>August 1, 2022 Update 😄!</strong> <i class="text-muted text-white">01:00 PM</i> <br> <i>What's new?</i></span>
            </div>
            <div class="card-body">
                <h4><span class="text-muted"># </span> Billing Module</h4>
                <ul>
                    <li>BAPA reading can now be deleted</li>
                    <li>Added Account Excemptions under <strong class="text-primary">Bills -> Excemptions</strong></li>
                    <li>Kwh Monitoring per Route under <strong class="text-primary">Bills -> Kwh Monitoring</strong></li>
                </ul>
                <h4><span class="text-muted"># </span> Bugs and Fixes</h4>
                <ul>
                    <li>Fixed Bugs at Meter Reading API for arrears</li>
                    <li>Fixed Bugs at DCR</li>
                </ul>
            </div>
        </div>
