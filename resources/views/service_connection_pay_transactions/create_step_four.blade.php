...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <p><strong><span class="badge-lg bg-warning">Step 6</span>Service Connection and Inspection Fees</strong>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <table class="table table-borderless table-sm">
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input type="checkbox" name="ElectricianAcredited" id="ElectricianAcredited"
                                            {{ $serviceConnection->ElectricianAcredited == null ? '' : ($serviceConnection->ElectricianAcredited == 'Yes' ? 'checked' : '') }}
                                        ...
                                        <select class="custom-select select2" name="ElectricianId" id="ElectricianId">
                                            ...
                                            @foreach ($electricians as $item)
                                                <option value="{{ $item->id }}"
                                                    {{ $item->id == $serviceConnection->ElectricianId ? 'selected' : '' }}>
                                                    {{ $item->Name }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <input type="text" class="form-control form-control-sm"
                                                name="ElectricianName" id="ElectricianName" disabled
                                                value="{{ $serviceConnection->ElectricianName }}">
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>Address</td>
                                        <th>
                                            <input type="text" class="form-control form-control-sm"
                                                name="ElectricianAddress" id="ElectricianAddress" disabled
                                                value="{{ $serviceConnection->ElectricianAddress }}">
                                        </th>
                                    </tr>
                                    <tr>
                                        <td>Contact No</td>
                                        <th>
                                            <input type="text" class="form-control form-control-sm"
                                                name="ElectricianContactNo" id="ElectricianContactNo" disabled
                                                value="{{ $serviceConnection->ElectricianContactNo }}">
                                        </th>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <tbody>
                            ...
                            @foreach ($laborPayables as $item)
                                <tr id="{{ $item->id }}">
                                    <td>{{ $item->Material }}</td>
                                    <td>
                                        <input type="number" onchange="computeLaborCharge('{{ $item->id }}')"
                                            onkeyup="computeLaborCharge('{{ $item->id }}')" step="any"
                                            class="form-control form-control-sm text-right"
                                            value="{{ $item->Qty != null ? $item->Qty : (($item->Material == 'Service Entrance') | ($item->Material == 'Street Light') ? 0 : $item->Qty) }}"
                                            name="{{ $item->id }}Quantity" id="{{ $item->id }}Quantity">
                                    </td>
                                    <td style="width: 120px;">
                                        <input type="number" step="any" class="form-control form-control-sm text-right"
                                            id="{{ $item->id }}Charge" value="{{ $item->Rate }}" disabled>
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm text-right"
                                            name="{{ $item->id }}ElecShare" value=""
                                            id="{{ $item->id }}ElecShare" disabled>
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm text-right"
                                    ...
                                    <td style="width: 80px;">
                                        <input type="number" step="any" class="form-control form-control-sm text-right"
                                            id="{{ $item->id }}VAT" value="{{ $item->VatPercentage }}" disabled>
                                    </td>
                                    <td>
                                        <input type="number" step="any" class="form-control form-control-sm text-right"
                                            name="{{ $item->id }}VATAmount" value="{{ $item->Vat }}"
                                            id="{{ $item->id }}VATAmount" disabled>
                                    </td>
                                    <td>
                    ...
                    <table class="table table-sm table-hover table-borderless">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="checkbox" name="BOHECOShareOnly" id="BOHECOShareOnly"
                                        {{ $totalPayments == null ? '' : ($totalPayments->BOHECOShareOnly == 'Yes' ? 'checked' : '') }}
                                        data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                </td>
                                <td></td>
                                <td></td>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select id="particulars" class="form-control form-control-sm">
                                    ...
                                    @foreach ($particulars as $particular)
                                        <option default-amount="{{ $particular->DefaultAmount }}"
                                            vat="{{ $particular->VatPercentage }}" value="{{ $particular->id }}">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group-sm">
                                <label>Amount</label>
                                <input id="particular_amt" class="form-control form-control-sm" type="number"
                                            ...
                                            <tr id="{{ $item->id }}">
                                                ...
                                                <td>
                                                    <button class='btn btn-xs btn-danger'
                                                        onClick='deleteParticulars("{{ $item->id }}")'><i
                    ...
                    <table class="table table-sm">
                        <thead>
                            ...
                            <th colspan="2" class="text-center"
                                title="Dynamic Demand Factor depends on the consumer type">Dynamic DF %</th>
                        ...
                        <tbody>
                            <tr>
                                <th></th>
                                <td>
                                    <input id="Load" name="Load" type="number" step="any"
                                        class="form-control form-control-sm text-right"
                                        value="{{ $serviceConnection->LoadCategory }}" disabled>
                                </td>
                                <td>x</td>
                                <td>
                                    <input id="PowerFactor" name="PowerFactor" type="number" step="any"
                                        class="form-control form-control-sm text-right" value=".85" disabled>
                                </td>
                                <td>x</td>
                                <td>
                                    <input id="DemandFactor" name="DemandFactor" type="number" step="any"
                                        class="form-control form-control-sm text-right"
                                        value="{{ $billDeposit != null ? $billDeposit->DemandFactor : ServiceConnections::getDemandFactor($serviceConnection->Alias) }}">
                                </td>
                                <td>x</td>
                                <td>
                                    <input id="Hours" name="Hours" type="number" step="any"
                                        class="form-control form-control-sm text-right" value="720" disabled>
                                </td>
                                <td>x</td>
                                <td>
                                    <input id="AverageRate" name="AverageRate" type="number" step="any"
                                        class="form-control form-control-sm text-right"
                                        value="{{ $billDeposit != null ? $billDeposit->AverageRate : UnbundledRates::getOneYearAverageRate($serviceConnection->Alias) }}"
                                        disabled>
                                </td>
                            </tr>
                            @if ($serviceConnection->Alias == 'I')
                                <tr>
                                    <th>+</th>
                                    <td>
                                        <input id="LoadI" name="LoadI" type="number" step="any"
                                            class="form-control form-control-sm text-right"
                                            value="{{ $serviceConnection->LoadCategory }}" disabled>
                                    </td>
                                    <td>x</td>
                                    <td>
                                        <input id="PowerFactorI" name="PowerFactorI" type="number" step="any"
                                            class="form-control form-control-sm text-right" value=".85" disabled>
                                    </td>
                                    <td></td>
                                    <td> </td>
                                    ...
                                    <td>x</td>
                                    <td>
                                        <input id="AverageTransmission" name="AverageTransmission" type="number"
                                            step="any" class="form-control form-control-sm text-right"
                                            value="{{ $billDeposit != null && $billDeposit->AverageTransmission != null ? $billDeposit->AverageTransmission : UnbundledRates::getOneYearAverageTransAndDist($serviceConnection->Alias) }}"
                                            disabled>
                                    </td>
                                </tr>
                            @endif
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-hover table-sm table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td>Account Type</td>
                                <th class="text-right">{{ $serviceConnection->AccountTypeName }}
                                    ({{ $serviceConnection->Alias }})</th>
                            </tr>
                            <tr>
                    ...
                    <table class="table table-hover table-sm table-borderless">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th class="text-right text-primary">₱ <span id="service-connection-fee-display">0.0</span>
                                </th>
                                <span id="service-connection-fee" style="display: none;">0</span>
                            </tr>
                            <tr>
                                <td>Elec. Wiring Labor Fees</td>
                                <th class="text-right text-primary">₱ <span id="wiring-labor-charge-display"
                                        data-toggle="tooltip"
                                        data-placement="left">{{ $totalPayments != null ? number_format($totalPayments->LaborCharge, 2) : '0.00' }}</span>
                                </th>
                            </tr>
                            <tr>
                                <td>BOHECO I Share</td>
                                <th class="text-right text-primary">₱ <span id="boheco-share" data-toggle="tooltip"
                                        data-placement="left">{{ $totalPayments != null ? number_format($totalPayments->BOHECOShare, 2) : '0.00' }}</span>
                                </th>
                            </tr>
                            <tr title="Bill deposits are being rounded down to the nearest hundredth">
                                <td>{{ ServiceConnections::isResidentials($serviceConnection->AccountType) ? 'Bill Deposit' : 'Energy Deposit' }}
                                </td>
                                <th class="text-right text-primary">₱ <span id="bill-deposit-display"
                                        data-toggle="tooltip"
                                        data-placement="left">{{ $totalPayments != null ? $totalPayments->BillDeposit : '0.00' }}</span>
                                </th>
                            </tr>
                            <tr>
                                <td>Other Payables</td>
                                <th class="text-right text-primary">₱ <span id="particulars-display"
                                        data-toggle="tooltip"
                                        data-placement="left">{{ $totalPayments != null ? number_format($totalPayments->Particulars, 2) : '0.00' }}</span>
                                </th>
                            </tr>
                            <tr>
                                <td>Total VAT</td>
                                <th class="text-right text-primary">₱ <span id="total-vat-display" data-toggle="tooltip"
                                        data-placement="left">{{ $totalPayments != null ? $totalPayments->TotalVat : '0.00' }}</span>
                                </th>
                            </tr>
                            <tr>
                                <td>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input"
                                            {{ $totalPayments != null ? ($totalPayments->Form2307TwoPercent == null || $totalPayments->Form2307TwoPercent == '0' ? '' : 'checked') : '' }}
                                            id="two-percent">
                                        <label class="custom-control-label" for="two-percent"
                                            style="font-weight: normal">2% WT</label>
                                    </div>
                                </td>
                                <th class="text-right text-danger">- ₱ <span
                                        id="two-percent-display">{{ $totalPayments != null ? ($totalPayments->Form2307TwoPercent != null ? number_format($totalPayments->Form2307TwoPercent, 2) : '') : '' }}</span>
                                </th>
                            </tr>
                            <tr>
                                <td>
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input"
                                            {{ $totalPayments != null ? ($totalPayments->Form2307FivePercent == null || $totalPayments->Form2307FivePercent == '0' ? '' : 'checked') : '' }}
                                            id="five-percent">
                                        <label class="custom-control-label" for="five-percent"
                                            style="font-weight: normal">5% WT</label>
                                    </div>
                                </td>
                                <th class="text-right text-danger">- ₱ <span
                                        id="five-percent-display">{{ $totalPayments != null ? ($totalPayments->Form2307FivePercent != null ? number_format($totalPayments->Form2307FivePercent, 2) : '') : '' }}</span>
                                </th>
                            </tr>
                            <tr>
                                ...
                                <th class="text-right text-primary" style="font-size: 2em; border-top: 1px solid #cdcdcd">
                                    ₱ <span id="overall-total-display">0</span></th>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="card-footer">
                    <button id="save-payment" class="btn btn-primary btn-sm"><i
                            class="fas fa-check-circle ico-tab-mini"></i>Submit</button>
                    <a href="{{ route('serviceConnections.show', [$serviceConnection->id]) }}"
                        class="btn btn-default btn-sm"><i class="fas fa-sign-out-alt ico-tab-mini"></i>Skip</a>
    ...
    <script type="text/javascript">
                ...
                if (jQuery.isEmptyObject(amnt)) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#particulars_table tbody').append(addRowToParticulars(
                                particularPaymentIdValue, particular, parseFloat(amnt)
                                .toFixed(2), vatValue.toFixed(2), total.toFixed(2)));
                            getOverAllTotal()
                        },
        ...
        function addRowToParticulars(id, particular, amnt, vat, total) {
            return "<tr id='" + id + "'>" +
                ...
                "<td><button class='btn btn-xs btn-danger' onClick=deleteParticulars('" + id +
        ...
        function calculateTableColumn(table, index, display) {
            ...
            $('#' + display).text(total.toLocaleString('en-US', {
        ...
        function validateLaborCharge() {
            if (isAccredited) {
                if (bohecoShareOnly) {
                    ...
                    $('#boheco-share').text(Number((getBOHECOIShare()).toFixed(2)).toLocaleString(undefined, {
                        minimumFractionDigits: 2
                    }))
                } else {
                    $('#wiring-labor-charge-display').text(Number((getTotalLaborCharge()).toFixed(2)).toLocaleString(
                        undefined, {
                            minimumFractionDigits: 2
                        }))
                    $('#boheco-share').text(Number((getBOHECOIShare()).toFixed(2)).toLocaleString(undefined, {
        ...
        function validateParticulars() {
            $('#particulars-display').text(Number((calculateTableColumnRaw('particulars_table', 1)).toFixed(2))
        ...
        function getOverAllTotal() {
            if (isAccredited) {
                if (bohecoShareOnly) {
                    overAllSubTotal = getBOHECOIShare() + serviceConnectionFees + getBillDepositNormal() +
                        calculateTableColumnRaw('particulars_table', 1)
                    witholdableVat = (getBOHECOIShare() * .12) + (serviceConnectionFees * .12) + calculateVatTableColumnRaw(
                        'particulars_table', 2)
                    overAllVat = (getBOHECOIShare() * .12) + (serviceConnectionFees * .12) + calculateVatTableColumnRaw(
                        'particulars_table', 2)
                } else {
                    overAllSubTotal = getTotalLaborCharge() + getBOHECOIShare() + serviceConnectionFees +
                        getBillDepositNormal() + calculateTableColumnRaw('particulars_table', 1)
                    witholdableVat = getTotalLaborVat() + (serviceConnectionFees * .12) + calculateVatTableColumnRaw(
                        'particulars_table', 2)
                    overAllVat = getTotalLaborVat() + (serviceConnectionFees * .12) + calculateVatTableColumnRaw(
                        'particulars_table', 2)
                }
            } else {
                overAllSubTotal = serviceConnectionFees + getBillDepositNormal() + calculateTableColumnRaw(
                    'particulars_table', 1)
            ...
            // TOOLTIPS
            $('#service-connection-fee-display').attr('title', '12% VAT: ' + Number((serviceConnectionFees * .12).toFixed(
                2)).toLocaleString(undefined, {
                minimumFractionDigits: 2
            }))

            $('#two-percent-display').text(Number(twoPercentVat.toFixed(2)).toLocaleString(undefined, {
                minimumFractionDigits: 2
            }))
            $('#five-percent-display').text(Number(fivePercentVat.toFixed(2)).toLocaleString(undefined, {
                minimumFractionDigits: 2
            }))
            $('#bill-deposit-display').text(Number(getBillDepositNormal().toFixed(0)).toLocaleString(undefined, {
                minimumFractionDigits: 2
            }))
            $('#total-vat-display').text(Number(overAllVat.toFixed(2)).toLocaleString(undefined, {
                minimumFractionDigits: 2
            }))
            $('#overall-total-display').text(Number(overAllTotal.toFixed(2)).toLocaleString(undefined, {
                minimumFractionDigits: 2
            }))
        }
        ...
        function showServiceConnectionFeeComputation() {
            Swal.fire({
                ...
                html: '<img src={{ URL::asset('imgs/svc-con-fees.jpg') }} width="100%">',
            })
        }
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    window.location.href =
                        "{{ url(route('serviceConnections.show', [$serviceConnection->id])) }}"
                },
                error: function(err) {
                    $('#save-payment').removeAttr('disabled')
                    Swal.fire({
