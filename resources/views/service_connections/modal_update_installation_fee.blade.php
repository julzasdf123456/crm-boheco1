            ...
            <div class="modal-body">
                        ...
                        @php
                            $materials =
                                $totalTransactions != null
                                    ? $totalTransactions->MaterialCost +
                                        $totalTransactions->LaborCost +
                                        $totalTransactions->ContingencyCost
                                    : 0;
                            ...
                            $materialsTotal =
                                $totalTransactions != null
                                    ? $totalTransactions->MaterialCost +
                                        $totalTransactions->LaborCost +
                                        $totalTransactions->ContingencyCost +
                                        $totalTransactions->MaterialsVAT
                                    : 0;
                        @endphp
                        <tr>
                ...
                <div style="width: 100%; margin-bottom: 10px;">
                    <div class="col-lg-6 custom-control custom-switch">
                        <input type="checkbox"
                            {{ $totalTransactions != null && $totalTransactions->InstallationPartial ? 'checked' : '' }}
                            class="custom-control-input" id="PromisoryToggle">
                        <label class="custom-control-label" for="PromisoryToggle" id="PromisoryToggleLabel">If
                            Installation Fee has a Promisory Note</label>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="DownPaymentPercentage" class="col-lg-6">Down Payment Percentage</label>
                    <input type="number" id="DownPaymentPercentage"
                        class="col-lg-6 form-control form-control-sm text-right" step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->InstallationFeeDownPaymentPercentage ? $totalTransactions->InstallationFeeDownPaymentPercentage : env('INSTALLATION_FEE_PARTIAL_DP_PERCENTAGE') }}"
                        disabled>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <input type="number" id="DownPaymentAmount"
                        class="col-lg-6 form-control form-control-sm text-right" step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->InstallationPartial ? $totalTransactions->InstallationPartial : null }}"
                        disabled>
                </div>

                <div class="form-group row">
                    <label for="Balance" class="col-lg-6">Balance</label>
                    <input type="number" id="Balance" class="col-lg-6 form-control form-control-sm text-right"
                        step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->InstallationFeeBalance ? $totalTransactions->InstallationFeeBalance : null }}"
                        disabled>
                </div>

                <div class="form-group row">
                    <label for="Terms" class="col-lg-6">Terms (in Months)</label>
                    <input type="number" id="Terms" class="col-lg-6 form-control form-control-sm text-right"
                        step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->InstallationFeeTerms ? $totalTransactions->InstallationFeeTerms : 1 }}"
                        disabled>
                </div>

                <div class="form-group row">
                    <label for="TermAmount" class="col-lg-6">Term Amount Per Month</label>
                    <input type="number" id="TermAmount" class="col-lg-6 form-control form-control-sm text-right"
                        step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->InstallationFeeTermAmountPerMonth ? $totalTransactions->InstallationFeeTermAmountPerMonth : null }}"
                        disabled>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-12 custom-control custom-switch">
                        <input type="checkbox"
                            {{ $totalTransactions != null && $totalTransactions->WithholdingTwoPercent != null && $totalTransactions->WithholdingTwoPercent > 0 ? 'checked' : '' }}
                            class="custom-control-input" id="MaterialsWTSwitch">
                        <label class="custom-control-label" for="MaterialsWTSwitch"
                            id="MaterialsWTSwitchLabel">Withholding Taxes For Materials (1% for Mat., 2% for Labor &
                            Svcs.)</label>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <input type="number" id="MaterialsOnePercent"
                        class="col-lg-6 form-control form-control-sm text-right" step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->WithholdingTwoPercent ? $totalTransactions->WithholdingTwoPercent : null }}"
                        readonly>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <input type="number" id="TransformerOnePercent"
                        class="col-lg-6 form-control form-control-sm text-right" step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->TransformerTwoPercentWT ? $totalTransactions->TransformerTwoPercentWT : null }}"
                        readonly>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <input type="number" id="LaborTwoPercent" class="col-lg-6 form-control form-control-sm text-right"
                        step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->Item1 ? $totalTransactions->Item1 : null }}"
                        readonly>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-lg-6 custom-control custom-switch">
                        <input type="checkbox"
                            {{ $totalTransactions != null && $totalTransactions->WithholdingFivePercent != null && $totalTransactions->WithholdingFivePercent > 0 ? 'checked' : '' }}
                            class="custom-control-input" id="WithholdingFivePercent">
                        <label class="custom-control-label" for="WithholdingFivePercent"
                            id="WithholdingFivePercentLabel">Installation WT 5%</label>
                    </div>
                    <input type="number" id="WithholdingFivePercentAmount"
                        class="col-lg-6 form-control form-control-sm text-right" step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->WithholdingFivePercent ? $totalTransactions->WithholdingFivePercent : null }}"
                        readonly>
                </div>

                {{-- TRANSFORMER WITHOLDING WITHHOLDING --}}
                <div class="divider"></div>
                <span class="text-muted"><i>Withholding Taxes For Transformer (Transformer VAT =
                        {{ $totalTransactions != null ? number_format($totalTransactions->TransformerVAT, 2) : 0 }})</i></span>

                <div class="form-group row">
                    <div class="col-lg-6 custom-control custom-switch">
                        <input type="checkbox"
                            {{ $totalTransactions != null && $totalTransactions->TransformerFivePercentWT != null && $totalTransactions->TransformerFivePercentWT > 0 ? 'checked' : '' }}
                            class="custom-control-input" id="TransformerFivePercentWT">
                        <label class="custom-control-label" for="TransformerFivePercentWT"
                            id="TransformerFivePercentWTLabel">Transformer WT 5%</label>
                    </div>
                    <input type="number" id="TransformerFivePercentWTAmount"
                        class="col-lg-6 form-control form-control-sm text-right" step="any"
                        value="{{ $totalTransactions != null && $totalTransactions->TransformerFivePercentWT ? $totalTransactions->TransformerFivePercentWT : null }}"
                        readonly>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="save"><i
                        class="fas fa-download ico-tab-mini"></i>Save and Confirm Payment</button>
            </div>
        </div>
    </div>
</div>
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        WithholdingFivePercent: jQuery.isEmptyObject($(
                            ...
                            '#WithholdingFivePercentAmount').val(),
                        TransformerTwoPercentWT: jQuery.isEmptyObject($('#TransformerOnePercent')
                            .val()) ? null : $('#TransformerOnePercent').val(),
                        Item1: jQuery.isEmptyObject($('#LaborTwoPercent').val()) ? null : $(
                            '#LaborTwoPercent').val(),
                        TransformerFivePercentWT: jQuery.isEmptyObject($(
                            '#TransformerFivePercentWTAmount').val()) ? null : $(
                            '#TransformerFivePercentWTAmount').val(),
                        InstallationFeeDownPaymentPercentage: jQuery.isEmptyObject($(
                            '#DownPaymentPercentage').val()) ? null : $(
                            '#DownPaymentPercentage').val(),
                        InstallationPartial: jQuery.isEmptyObject($('#DownPaymentAmount').val()) ?
                            null : $('#DownPaymentAmount').val(),
                        InstallationFeeBalance: jQuery.isEmptyObject($('#Balance').val()) ? null :
                            $('#Balance').val(),
                        InstallationFeeTerms: jQuery.isEmptyObject($('#Terms').val()) ? null : $(
                            '#Terms').val(),
                        InstallationFeeTermAmountPerMonth: jQuery.isEmptyObject($('#TermAmount')
                            .val()) ? null : $('#TermAmount').val(),
                    },
